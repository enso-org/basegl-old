...
main = () ->
  ...
  code1.firstLine.setColor parensColor, 4  , 6
  code1.firstLine.setColor parensColor, 13 , 14
  code1.firstLine.setColor parensColor, 26 , 27
  code1.firstLine.setColor numberColor, 6  , 7
  code1.firstLine.setColor numberColor, 8  , 9
  code1.firstLine.setColor numberColor, 10 , 11
  code1.firstLine.setColor numberColor, 12 , 13
  code1.firstLine.setColor numberColor, 25 , 26
  code1.firstLine.setColor dotColor   , 7  , 8
  code1.firstLine.setColor dotColor   , 9  , 10
  code1.firstLine.setColor dotColor   , 11 , 12
  code1.firstLine.setColor dotColor   , 14 , 15
  code1.firstLine.setColor dotColor   , 19 , 20
