...
export function fastFunction (dict:{[k: string]:string}, f:(...args:any[])=>any) : () => any {
...
export function mixed<T extends NamedConstructors[]>(...mixinsArr: T):
...
type InstanceValues<T extends NamedConstructors> 
    = T extends any 
...
type PublicInstance<T extends new (...args: any[]) => any> 
...
function embedMixin (base:any, mixinName: string, mixin:any) {
    ...
    Object.defineProperty(base.prototype, mixinName, 
        { get: fastFunction({mixinName}, 
            function(this:any){ return this._$mixinName })
        , set: fastFunction({mixinName},
            function(this:any,v:any){ this._$mixinName = v })                            
        , configurable: true
        })
...
function embedMixinField (base:any, name:string, mixin:any, field:string) {
    ...
    if(isFunc){
        ...
        Object.defineProperty(base.prototype, field, 
            { get: fastFunction({name, field}, 
                function(this:any){ return this.$name.$field })
            , set: fastFunction({name, field},
                function(this:any,v:any){ this.$name.$field = v })                            
            , configurable: true
            })
    }
}
